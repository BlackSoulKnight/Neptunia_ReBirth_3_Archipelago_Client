...
namespace Nep3ArchipelagoClient.src.Neptunia_3_Data.ProgressiveGear
{
    internal class ArmorGear:ProgressiveGear
    {
        public ArmorGear()
        {
            ...
            GearList.Add(1, new List<short>() { 1630, 1637, 1638 });
            GearList.Add(2, new List<short>() { 1639, 1643, 1644, 1645, 1646 });
            GearList.Add(3, new List<short>() { 1647, 1648, 1649, 1650, 1651 });
            GearList.Add(4, new List<short>() { 1652, 1653, 1654, 1655, 1656 });
            GearList.Add(5, new List<short>() { 1657, 1658, 1659, 1660, 1661, 1662, 1663, 1664, 1665, 1666 });
            GearList.Add(6, new List<short>() { 1667, 1668, 1669, 1670 });
